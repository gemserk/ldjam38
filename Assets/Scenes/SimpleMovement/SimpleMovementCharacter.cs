...
public class SimpleMovementCharacter : MonoBehaviour
{
	...
	{
		character.transform.position = worldMovement.Move(character.transform.position, new Vector3(1, 0, 0), heightTolerance);
...
//		character.transform.position += new Vector3 (-movementVector.x, 0, 0);
	...
	{
		character.transform.position = worldMovement.Move(character.transform.position, new Vector3(0, 0, 1), heightTolerance);
